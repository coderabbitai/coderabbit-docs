...
<ListItems items={[
  <><code>Code</code> - Full</>,
  <><code>Work Items</code> - Read, write, and manage</>,
  <><code>Build</code> - Read</>
]} />
...
<ListItems orderedList items={[
  <><strong>Navigate to project's Service Hooks Page</strong>: Go to the service hooks configuration page in the desired Azure DevOps project.</>,
  <><strong>Add the following webhooks</strong>:
    <ListItems nested orderedList items={[
      <>Pull request created</>,
      <>Pull request updated</>,
      <>Pull request commented on</>
    ]} />
  </>,
  <><strong>Add Webhook URL</strong>: Enter the URL pointing to the CodeRabbit service, followed by <code>/azure_webhooks</code> (e.g., <code>http://127.0.0.1:8080/azure_webhooks</code>) for each webhook.</>
]} />
