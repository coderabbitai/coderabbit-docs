...
Notes:
• Please share any feedback in the discussion post.
...
• Pause Reviews:
o Use @coderabbitai pause in a PR comment to halt ongoing reviews.
• Resume Reviews:
o Enter @coderabbitai resume in a PR comment to continue paused reviews.
• On-Demand Reviews:
o Disable automatic reviews for your repository to switch to on-demand reviews.
o Use @coderabbitai review in a PR comment. This command will override all review filters that might be set up in the repository settings and will initiate a one-time review.
• Help Command:
o You can at any time post @coderabbitai help in a PR comment to get the list of all valid commands.
Oct 12, 2023
